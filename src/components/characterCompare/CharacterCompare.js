    ...
    return (
      <div className={showHideClassName + " characterCompareModalContainer"}>
        <div className="modal-main">
          {this.state.character && this.state.class && (
            <table className="compareTable">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    {this.numberWithCommas(
                      Math.round(this.state.character.stats.mastery * 100) / 100
                    )}
                  </td>
                  <td className="compareStat">Mastery</td>
                  <td>
                    {this.numberWithCommas(
                      Math.round(this.props.character.stats.mastery * 100) / 100
                    )}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>
                    {this.numberWithCommas(
                      Math.round(this.state.character.stats.versatility * 100) /
                        100
                    )}
                  </td>
                  ...
                  <td>
                    {this.numberWithCommas(
                      Math.round(this.props.character.stats.versatility * 100) /
                        100
                    )}
                  </td>
                </tr>
